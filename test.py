...
from mytransformer.utils import evaluate_on_env, get_d4rl_normalized_score, get_d4rl_dataset_stats
from mytransformer.model import GPT2
...
if __name__ == "__main__":
    ...
    parser.add_argument('--chk_pt_dir', type=str, default='./')
